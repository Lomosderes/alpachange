...
class Petition(models.Model):
    ...
    def created_by_alias(self):
        profile = getattr(self.author, 'userprofile', None)
        return profile.comment_alias if profile and profile.comment_alias else self.author.username
...
class Comment(models.Model):
    ...
    def author_alias(self):
        """Obtiene el alias desde el perfil del usuario."""
        profile = getattr(self.author, 'userprofile', None)
        return profile.comment_alias if profile and profile.comment_alias else self.author.username
